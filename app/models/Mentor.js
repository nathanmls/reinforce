...
export const MentorSchema = {
  ...
  students: Array, // Array of student IDs this mentor is assigned to
  managers: Array, // Array of manager IDs this mentor is assigned to
  createdAt: Date,
  updatedAt: Date,
...
export function validateMentor(mentorData) {
  ...
  if (!mentorData.students) mentorData.students = [];
  if (!mentorData.managers) mentorData.managers = [];
  if (!mentorData.institutions) mentorData.institutions = [];
...
export const ELEVENLABS_AGENT_TEMPLATES = {
  ELEMENTARY_TEACHER: {
    ...
    description:
      'A friendly and patient elementary school teacher who specializes in making complex concepts simple for young students.',
    initialMessage:
      "Hello! I'm your elementary school teacher. How can I help you with your learning today?",
    voiceId: '21m00Tcm4TlvDq8ikWAM', // Default voice ID, can be changed
  },
  MATH_SCIENCE_SPECIALIST: {
    name: 'Math and Science Specialist',
    description:
      'An expert in mathematics and science who can explain complex concepts in an engaging and understandable way.',
    initialMessage:
      "Hi there! I'm your math and science specialist. What would you like to learn about today?",
    voiceId: 'AZnzlk1XvdvUeBnXmlld', // Default voice ID, can be changed
  },
  LANGUAGE_ARTS_EXPERT: {
    name: 'Language Arts Expert',
    description:
      'A literature and language arts specialist who can help with reading comprehension, writing, and literary analysis.',
    initialMessage:
      "Hello! I'm your language arts expert. Ready to explore the world of literature and writing?",
  ...
  HISTORY_SOCIAL_STUDIES: {
    ...
    description:
      'A knowledgeable history and social studies teacher who brings historical events and social concepts to life.',
    initialMessage:
      "Welcome! I'm your history and social studies teacher. What period of history or social topic would you like to explore?",
