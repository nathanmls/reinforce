...
import { FiMoon, FiSun, FiGlobe, FiLock, FiVolume2, FiBell } from 'react-icons/fi';
  ...
  return (
    <div className="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow rounded-lg divide-y divide-gray-200">
        ...
        <SettingSection title="Theme" icon={settings.theme === 'dark' ? FiMoon : FiSun}>
          <div className="flex items-center justify-between">
            ...
            >
              <span className={`${settings.theme === 'dark' ? 'translate-x-6' : 'translate-x-1'} inline-block h-4 w-4 transform rounded-full bg-white transition`} />
            </Switch>
          </div>
        </SettingSection>
        ...
        <SettingSection title="Security" icon={FiLock}>
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              >
                <span className={`${settings.security.twoFactorAuth ? 'translate-x-6' : 'translate-x-1'} inline-block h-4 w-4 transform rounded-full bg-white transition`} />
              </Switch>
            </div>
            <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <select
                ...
                onChange={(e) => handleSettingChange('voice', 'voiceType', e.target.value)}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              >
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleSettingChange('voice', 'speed', Number(e.target.value))}
                className="w-full"
              />
            </div>
          </div>
        ...
        <div className="p-6">
          <div className="flex justify-end space-x-3">
            ...
            {success && <p className="text-green-500 text-sm">Settings updated successfully!</p>}
            <button
              type="submit"
              disabled={loading}
