          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-6 bg-gray-50">
              ...
              <p className="text-2xl font-bold text-blue-600">
                {
                  students.filter(
                    (s) =>
                      new Date(s.metrics.lastActive).toDateString() ===
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              ...
              <p className="text-2xl font-bold text-green-600">
                {Math.floor(
                  students.reduce(
                    (acc, s) => acc + s.metrics.averageSessionDuration,
                    0
                  ) / students.length || 0
                )}
                m
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="w-full bg-gray-200 rounded-full h-2.5">
                          <div
                            ...
                            style={{
                              width: `${student.metrics.progressRate}%`,
                            }}
                          ></div>
                        </div>
...
export default function StudentsPage() {
  return (
    <ClientOnlyFirebase
      fallback={<LoadingSpinner message="Loading students data..." />}
    >
      <StudentsContent />
    </ClientOnlyFirebase>
  );
