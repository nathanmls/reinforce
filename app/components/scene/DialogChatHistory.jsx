...
export default function DialogChatHistory({
  ...
  dialogHistory = [
    { speaker: 'You', message: 'Hello Tia! How are you today?' },
    {
      speaker: 'Tia',
      message:
        "I'm doing great! How can I help you with your learning journey?",
    },
    { speaker: 'You', message: "I'm interested in learning more about AI." },
    {
      speaker: 'Tia',
      message:
        "That's wonderful! AI is a fascinating field with many applications.",
    },
  ],
    ...
    return lastMessages.map((msg) => {
      if (typeof msg === 'string') {
        ...
        return {
          ...
          speaker: speaker,
          backgroundColor:
            speaker === 'You' ? 'rgba(138,43,226,0.3)' : 'rgba(70,130,180,0.3)',
          speakerColor: speaker === 'You' ? '#0000FF' : '#8A2BE2', // Blue for You, Purple for Tia
        };
      } else {
