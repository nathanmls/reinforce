...
export default function WelcomeSection({ language = 'en' }) {
  ...
  return (
    <div id='welcome' className="relative isolate flex items-center h-screen px-6 pt-14 lg:px-8">
      <div className="mx-auto flex flex-col w-full max-w-7xl items-start py-32 sm:py-48 lg:py-56">
