...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="relative bg-gray-900 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit} className="mx-auto mt-16 max-w-xl">
          ...
          <div className="mt-10">
            <button
              type="submit"
              className="block w-full rounded-md bg-[#C7DF88] px-3.5 py-2.5 text-center text-sm font-semibold text-gray-900 shadow-sm hover:bg-[#B8D277] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#C7DF88]"
            >
              Enviar mensagem
            </button>
          </div>
