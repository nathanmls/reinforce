        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <div className="lg:pr-8 lg:pt-4">
            <div className="lg:max-w-lg">
              <h2 className="text-base font-semibold leading-7 text-indigo-600">Aprenda mais rápido</h2>
              <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Uma nova forma de aprender</p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Nossa plataforma oferece uma experiência única de aprendizado, combinando tecnologia e mentoria humana para maximizar seu potencial.
              </p>
